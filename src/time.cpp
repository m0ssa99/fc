...
namespace fc {
    ...
    time_point_sec time_point_sec::from_iso_string(const std::string &s) {
        ...
        } FC_RETHROW_EXCEPTIONS(warn, "unable to convert ISO-formatted std::string to fc::time_point_sec")
    }
    ...
    time_point time_point::from_iso_string(const std::string &s) {
        ...
        } FC_RETHROW_EXCEPTIONS(warn, "unable to convert ISO-formatted std::string to fc::time_point")
    }
