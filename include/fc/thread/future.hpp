...
namespace fc {
    ...
    public:
        ...
        void on_complete(CompletionHandler &&c) {
            _on_complete(
                    new detail::completion_handler_impl<CompletionHandler, void>(fc::forward<CompletionHandler>(c)));
        }
    ...
    public:
        ...
        bool canceled() const {
            return m_prom ? m_prom->canceled() : true;
        }
